...
namespace AgriculturePresentation.Controllers
{
    public class ReportController : Controller
    {
        ...
        public IActionResult StaticReport()
        {
            ...
            var workBook = excelPackage.Workbook.Worksheets.Add("Doyas1");
            ...
            // Eklemiş olduğum bu değerleri bir byte dizisi içinde ele alıcam
        ...
        // Yukarıda static bir şekilde verileri kendi elimizle girdik bu sefer dinamik bir şekilde tablomuzdan alıcaz.


        // İlk önce listeleme işlemi yapıyoruz.
        public List<ContactModel> ContactList()
        {
            ...
            using (var context = new AgricultureContext())
            {
                ...
                {
                    // ContactModel içerisinde propertyler geldi.x de bize context (AgricultureContext sınıfı içindeki) içerisinde yer alan propertyleri select metoduyla getiiyor
        ...
        public IActionResult ContactReport() // İletişim raporları
        {
            // Yukarıdaki listeyi viewe çağırıcaz.
            ...
            using(var workBook=new XLWorkbook())
            {
                ...
                // Başlıkları atadım şimdi onların altına verilerin gelmesini sağlayacağım.
        ...
        public IActionResult AnnouncementReport() 
        {
            ...
            using (var workBook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    workBook.SaveAs(stream);              // Çalışma kitabını farklı olarak kaydet.
                    var content = stream.ToArray();
